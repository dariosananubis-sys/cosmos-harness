...
de mercado: aquel exige levantar Postgres, IPFS y el propio nodo como tres servicios Docker
separados — viable, pero pesado en cualquier maquina modesta; este es un proceso unico que arranca
y reindexa en caliente. Para un contrato propio, la eleccion sensata; para un indice publico
compartido, el estandar sigue siendo el otro.
