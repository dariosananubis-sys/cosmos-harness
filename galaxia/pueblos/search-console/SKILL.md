...
python3 scripts/gsc-search-console.py add-property https://ejemplo.test/
python3 scripts/gsc-search-console.py get-token   https://ejemplo.test/   # devuelve el <meta ...>
python3 scripts/gsc-search-console.py verify      https://ejemplo.test/   # tras inyectar el meta
python3 scripts/gsc-search-console.py submit-sitemap https://ejemplo.test/ https://ejemplo.test/sitemap_index.xml
python3 scripts/gsc-search-console.py inspect-url    https://ejemplo.test/ https://ejemplo.test/contacto/

# el mismo testigo, sin arrastrar la biblioteca oficial de autenticacion:
node --input-type=module -e "
import { serviceAccountAccessToken } from './scripts/gsc-service-account-token.js';
...
comparten `scripts/log.py`, que da el formato de registro común a esta familia de envoltorios de
