...
echo '{"hook_event_name":"PreToolUse","tool_name":"Bash","session_id":"adv",
 ...
 "tool_input":{"command":"echo x > /Users/<usuario>/cosmos/galaxia/COSMOS.md"}}' \
 | python3 -m puente.sesion --formato exit2; echo "EXIT=$?"

# B) cwd = /Users/<usuario>  (el PADRE real del repo) -> SILENCIO
echo '{"hook_event_name":"PreToolUse","tool_name":"Bash","session_id":"adv",
 "cwd":"/Users/<usuario>",
 "tool_input":{"command":"echo x > /Users/<usuario>/cosmos/galaxia/COSMOS.md"}}' \
 | python3 -m puente.sesion --formato exit2; echo "EXIT=$?"
...
```
D3) echo x | tee /Users/<usuario>/cosmos/galaxia/COSMOS.md   cwd=/Users/<usuario> -> exit=0, salida VACIA
D5) cp /tmp/falso.md /Users/<usuario>/cosmos/galaxia/COSMOS.md  cwd=/Users/<usuario> -> exit=0, salida VACIA
```
...
`cwd=/Users/<usuario>` no es un caso rebuscado: es el padre del checkout, y es exactamente
...
```bash
printf '%s' '{"hook_event_name":"PreToolUse","tool_name":"Write","cwd":"/Users/<usuario>/cosmos","tool_input":{"file_path":"galaxia/COSM' \
 | python3 -m puente.sesion --formato exit2; echo "EXIT=$?"
```
...
```
  File "/Users/<usuario>/cosmos/cosmos/acertar.py", line 306, in formatear_contraste
...
```bash
cd /Users/<usuario>/cosmos
for f in /Users/<usuario>/cosmos/cosmos/abrir.py ./cosmos/abrir.py Makefile "" ; do
  echo -n "$f -> "
...
```
/Users/<usuario>/cosmos/cosmos/abrir.py -> []          <-- ruta absoluta: VACIO
...
```bash
cd /Users/<usuario>/cosmos && python3 - <<'PY'
import re, pathlib
...
```bash
cd /Users/<usuario>/cosmos && python3 progress/revision-adversarial-cosmos-2026-09-02/pruebas/probe_escala.py
```
