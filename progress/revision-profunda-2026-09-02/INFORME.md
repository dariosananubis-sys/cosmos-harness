...
echo '{"hook_event_name":"PreToolUse","tool_name":"Bash","session_id":"rp",
 "cwd":"/Users/<usuario>/cosmos",
 "tool_input":{"command":"cp /tmp/x.md /Users/<usuario>/cosmos/galaxia/COSMOS.md"}}' \
...
echo '{"hook_event_name":"PreToolUse","tool_name":"Bash","session_id":"rp",
 "cwd":"/Users/<usuario>/cosmos",
 "tool_input":{"command":"cp /tmp/rp/limpio/README.md /Users/<usuario>/cosmos/galaxia/COSMOS.md"}}' \
 | python3 -m puente.sesion --formato exit2; echo "EXIT=$?"
```

```
A) COSMOS  sesion  rojo  escritura a mano sobre una ruta de veredicto
   /Users/<usuario>/cosmos/galaxia/COSMOS.md  (protegida: …/galaxia/COSMOS.md)
...
```
D2) cat /tmp/rp/falso/galaxia/galaxia.md > /Users/<usuario>/cosmos/galaxia/COSMOS.md
    EXIT=0   salida = 0 bytes
E2) cat /etc/hosts                        > /Users/<usuario>/cosmos/galaxia/COSMOS.md
...
cmd='cp /tmp/rp/limpio/README.md /Users/<usuario>/cosmos/galaxia/COSMOS.md'
print('objetivos_de_escritura:', [objetivos_de_escritura(o) for o in ordenes(cmd)])
print('_rutas_del_evento    :', _rutas_del_evento({'tool_input':{'command':cmd},'cwd':'/Users/<usuario>/cosmos'}))"
```

```
objetivos_de_escritura: [['/Users/<usuario>/cosmos/galaxia/COSMOS.md']]     <- exactamente el destino
_rutas_del_evento    : [/tmp/rp/limpio,                                        <- gana este
                        /Users/<usuario>/cosmos/galaxia,
                        /Users/<usuario>/cosmos]
```
...
sed -e 's/entrada = 4000/entrada = 3000/' \
    -e 's#arbol = "galaxia"#arbol = "/Users/<usuario>/cosmos/galaxia"#' \
    -e 's#indice = "galaxia/COSMOS.md"#indice = "/Users/<usuario>/cosmos/galaxia/COSMOS.md"#' \
    -e 's#registro = "registro"#registro = "/Users/<usuario>/cosmos/registro"#' \
...
```bash
cd /Users/<usuario>/cosmos    # (ejecutado sobre el tar congelado de 6a32781)
...
cd /Users/<usuario>/cosmos && git archive 6a32781 | tar -x -C /tmp/rp/orf2
cd /tmp/rp/orf2
...
cd /Users/<usuario>/cosmos && git archive HEAD | tar -x -C /tmp/rp/b04
cd /tmp/rp/b04
...
```bash
cd /Users/<usuario>/cosmos && echo '{}' > /tmp/rp/dict.json
...
```bash
cd /Users/<usuario>/cosmos && python3 -c "
