...
# COSMOS se construye encima de VanguardIA-Harness

**Fecha:** 2026-09-01 · **Estado:** decidido · **Reversible:** sí, mientras no se migre `compilar`

## Qué se decide

COSMOS **no reescribe** la maquinaria de `dariosananubis-sys/VanguardIA-Harness`. La adopta, y
