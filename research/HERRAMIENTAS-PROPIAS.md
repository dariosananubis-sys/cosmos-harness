...
propios de el responsable (`<la-agencia>-deploy`, `<producto>`, `seo-guardian`, `Chronos`, y el `tools/` local de
...
Repos revisados, en el orden pedido: `<la-agencia>-deploy` (yo), `<producto>` (yo, descartado entero),
