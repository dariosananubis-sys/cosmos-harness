...
```
$ cd /Users/dariosatino/cosmos && git rev-parse HEAD && git status --porcelain | wc -l
...
```
$ cd /Users/dariosatino/cosmos && git ls-files | grep -E '^\.cosmos|^\.claude'
.claude/skills/probar-salida
.claude/skills/revisar-formato
.cosmos/compilado-galaxia.json
.cosmos/compilado.json

$ git clone -q /Users/dariosatino/cosmos /tmp/clon && cd /tmp/clon
...
```
$ ls /Users/dariosatino/cosmos/.git/hooks/pre-commit
ls: ...: No such file or directory
$ ls /Users/dariosatino/cosmos/.github
ls: ...: No such file or directory
```
...
```
$ cd /Users/dariosatino/cosmos && python3 -m puente.secretos --todo >/dev/null; echo $?
1
```
...
2. **Rutas absolutas del usuario**: 12 apariciones de `/Users/dariosatino` en 6 ficheros
...
**El puente, migrado.** Comparé fichero a fichero contra `/Users/dariosatino/vh-ref/scripts/` (solo
