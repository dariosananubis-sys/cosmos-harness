...
| «Las cuatro piezas de <agencia>… ninguna migrada» | `puente/` con 5 módulos, 1.446 líneas, 35 tests | `wc -l puente/*.py` |
...
- `puente/proyectar.py:34-35`: `FICHEROS_RAIZ = ("AGENTS.md", "CLAUDE.md")` y
  ...
  QUEDA.md PROGRESS.md` → **vacío**. `.agents` es vocabulario de <agencia>-Harness que COSMOS no
